package org.wit.tripshare.ui.auth
...
import org.wit.tripshare.databinding.LoginBinding
import org.wit.tripshare.ui.home.Home
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        Timber.i("tripShare Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
